...
| 항목 | 원본 (딸깍분석) | LITE |
|---|---|---|
| 분석 모델 | Gemini 2.5 Flash | Gemini 2.0 Flash-Lite |
| 입력 비용 (1M 토큰) | $0.15 | $0.01 |
| 출력 비용 (1M 토큰) | $0.60 | $0.04 |
| 1회 분석 비용 | ~2~4원 | ~0.1~0.3원 |
| 패널 위치 | 오른쪽 | 왼쪽 |
| 테마 색상 | 보라색 | 초록색 |
...
5. DOM + 검색 결과를 Gemini 2.0 Flash-Lite에 전송하여 분석
6. 결과 표시 + 토큰 비용 계산
```
...
- Gemini API (2.0 Flash-Lite: 분석 + 검색어 생성)
